...
const CONFIG = {
  ...
  // ── Foto polaroid asociada a cada frase corta ──────
  fotosFrases: {
  ...
  // ── Mensaje al terminar la playlist ────────────────
  ...
  velocidadOrbita: 0.0025,
  cantidadParticulas: 3500,
  duracionCarga: 2.5,
  radioCorazon: 70,
  windEffectRadius: 140,
  imgOrbitMinSize: 80,
  imgOrbitMaxSize: 120,
};
